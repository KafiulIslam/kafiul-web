...
const fitJerkAppDes =
    "FitJerk is the hilarious app that provides brutal motivational quotes direct to your phone, for free, every morning. Join the community, stay accountable, have a laugh and get fit. Let’s go legends!";
const sophiaAppDes =
...
const bmiAppdes = "BMI meter will check your health condition comparing your weight to your height and give proper consultancy. I build the whole project alone. I build Responsive, pixel-perfect UI. Besides, I manage the app state with Getx and important thing is this app is successfully live on google play store. To build the app I rely on Figma, GitHub, Android Studio, and so on.";
const weatherAppDes = "Weather Check app will help you to know the current condition of the weather. Besides, it provides the day's max and minimum temperature, atmospheric pressure, weather conditions, visibility distance, relative humidity, wind speed, etc. With best user experience it will give you realtime weather update.";
